...
import Image from "next/legacy/image"; // Import Image from Next.js
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center h-full">
          ...
          <div className="w-full md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">About Mock-Up Construction</h2>
          </div>
        </div>
      </section>
